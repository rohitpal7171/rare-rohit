      ...
      <div className="section-container max-w-3xl">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-8">
          <motion.div variants={fadeInUp} className="space-y-4 text-center">
            ...
            <h1 className="section-title font-display text-gold">{t('vidaai.name')}</h1>
            <p className="font-script text-2xl text-ivory/60">{t('vidaai.tagline')}</p>
          ...
          <motion.div variants={fadeInUp} className="card-divine space-y-4">
            ...
            <p className="font-body leading-relaxed text-ivory/70">{t('vidaai.description')}</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="card-divine space-y-4 border-gold/40">
            ...
            <p className="font-body italic leading-relaxed text-ivory/70">{t('vidaai.significance')}</p>
          </motion.div>
          <motion.div variants={fadeInUp} className="card-divine">
            <RitualFacts slug="vidaai" />
          </motion.div>
