  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gold-shimmer':   'linear-gradient(90deg, #A07830 0%, #C9A84C 25%, #E2C97E 50%, #C9A84C 75%, #A07830 100%)',
        'divine-gradient':'linear-gradient(180deg, #2D1B4E 0%, #1e1035 100%)',
        'divine-radial':  'radial-gradient(ellipse at top, rgba(45,27,78,0.95) 0%, rgba(128,0,32,0.98) 100%)',
        'hero-overlay':   'linear-gradient(180deg, rgba(45,27,78,0.7) 0%, rgba(128,0,32,0.85) 60%, rgba(96,0,24,0.95) 100%)',
        'card-dark':      'linear-gradient(145deg, rgba(45,27,78,0.08) 0%, rgba(128,0,32,0.12) 100%)',
        'card-glow':      'linear-gradient(145deg, rgba(201,168,76,0.05) 0%, rgba(201,168,76,0.02) 100%)',
        'ivory-subtle':   'linear-gradient(180deg, #FDF6EC 0%, #F5E6D0 100%)',
        // Decorative
        'mandala-radial': 'repeating-radial-gradient(circle at 50% 50%, transparent 0, transparent 30px, rgba(201,168,76,0.03) 30px, rgba(201,168,76,0.03) 31px)',
      },
  ...
  plugins: [
    ...
    plugin(({ addUtilities, addComponents, theme }) => {
      ...
      addUtilities({
        ...
        // Gradient text
        '.text-gradient-gold': {
          background:              'linear-gradient(90deg, #A07830 0%, #C9A84C 30%, #E2C97E 50%, #C9A84C 70%, #A07830 100%)',
        ...
        // Glow effects
        '.glow-gold': {
          filter: 'drop-shadow(0 0 8px rgba(201, 168, 76, 0.5)) drop-shadow(0 0 20px rgba(201, 168, 76, 0.2))',
        },
        '.glow-saffron': {
      ...
      addComponents({
        '.section-padding': {
          ...
          paddingTop:    '4rem',
          paddingBottom: '4rem',
          '@screen sm': { paddingLeft: '1.5rem', paddingRight: '1.5rem', paddingTop: '5rem', paddingBottom: '5rem' },
          '@screen lg': { paddingLeft: '2rem',   paddingRight: '2rem',   paddingTop: '6rem', paddingBottom: '6rem' },
        ...
        '.mandala-bg': {
          backgroundImage:   'radial-gradient(ellipse at 20% 0%, rgba(45,27,78,0.95) 0%, rgba(96,0,24,0.9) 50%, rgba(45,27,78,0.98) 100%)',
